...
/***/ function(module, exports) {
	...
	var selectTodo = exports.selectTodo = function selectTodo(id) {
	    return {
	        type: 'SELECT_TODO',
	        selectedTodoId: id
	    };
	...
	var unselectTodo = exports.unselectTodo = function unselectTodo(id) {
	    return {
	        type: 'UNSELECT_TODO',
	        unselectedTodoId: id
	    };
	...
	var updateTodo = exports.updateTodo = function updateTodo(id, newText) {
	    return {
	        type: 'UPDATE_TODO',
	        updatedTodoId: id,
