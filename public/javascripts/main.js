...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lib = __webpack_require__(147);

	var _react = __webpack_require__(148);

	var _react2 = _interopRequireDefault(_react);

	var _todosList = __webpack_require__(160);
	...
	function addEventListeners() {
	    ...
	    createButtton.addEventListener('touchstart', function () {
	        ...
	        (0, _lib.createTodo)(text, function (err, id) {
	            if (err) {
	                return alert(err);
	            }
	            todosList.push({ id: id, text: text });
	            _reactDom2.default.render(_react2.default.createElement(_todosList2.default, { todoItems: todosList }), document.getElementsByClassName('target')[0]);
	            textField.value = '';
	        });
	    });
	...
	function updateTodos() {
	    (0, _lib.getTodosList)(function (err, todos) {
	        todosList = todos;
	        _reactDom2.default.render(_react2.default.createElement(_todosList2.default, { todoItems: todos }), document.getElementsByClassName('target')[0]);
	    });
	}
...
/***/ function(module, exports) {
	...
	function updateTodo(id, text, callback) {
	    ...
	    xhr.send(JSON.stringify({ id: id, text: text }));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoItem = __webpack_require__(161);
	...
	exports.default = function (_ref) {
	    ...
	    return _react2.default.createElement(
	        'div',
	        { className: 'todo-list' },
	        todoItems.map(function (todo, idx) {
	            return _react2.default.createElement(_todoItem2.default, { key: todo.id, id: todo.id, text: todo.text });
	        })
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItem = function (_React$Component) {
	    ...
	    function TodoItem(props) {
	        ...
	        _this.onDeleteButtonTouch = _this.onDeleteButtonTouch.bind(_this);
	        _this.onSaveButtonTouch = _this.onSaveButtonTouch.bind(_this);
	    ...
	    _createClass(TodoItem, [{
	        ...
	        key: 'onDeleteButtonTouch',
	        value: function onDeleteButtonTouch(event) {
	            var node = _reactDom2.default.findDOMNode(this);
	            var self = this;
	            (0, _lib.deleteTodo)(this._id, function (err) {
	                if (err) {
	                    return alert(err);
	                }
	        ...
	        key: 'onSaveButtonTouch',
	        value: function onSaveButtonTouch(event) {
	            var self = this;
	            var currentText = event.target.previousElementSibling.value;
	            (0, _lib.updateTodo)(this._id, currentText, function (err) {
	                if (err) {
	                    return alert(err);
	                }
	        ...
	        value: function render() {
	            ...
	            if (this.state.state === 'view') {
	                return _react2.default.createElement(
	                    'div',
	                    { className: 'todo-list__item-block' },
	                    _react2.default.createElement(
	                        'div',
	                        { className: itemClass, onTouchStart: this.onTouchStart, onTouchMove: this.onTouchMove },
	                        this.state.text
	                    ),
	                    _react2.default.createElement('div', { className: 'button', type: 'button', onTouchStart: this.onDeleteButtonTouch })
	                );
	            } else {
	                return _react2.default.createElement(
	                    'div',
	                    { className: 'todo-list__edit-block' },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'edit' },
	                        _react2.default.createElement('textarea', { className: 'text', rows: '3', onChange: this.handleChanges, value: this.state.text }),
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'button', type: 'button', onTouchStart: this.onSaveButtonTouch },
	                            'Сохранить'
	                        )
	                    )
	                );
