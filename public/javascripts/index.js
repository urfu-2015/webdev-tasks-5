...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoListItemComponent = React.createClass({
	    displayName: 'TodoListItemComponent',
	    ...
	    handleTouchLiStart: function (e) {
	        ...
	        this.eventObj.timeout = setTimeout(function () {
	            this.props.onElementSetDrag(this.props.id, this.eventObj.liStartX + touch.pageX, this.eventObj.liStartY + touch.pageY);
	        }.bind(this), 1000);
	    },
	    ...
	    handleTouchLiMove: function (e) {
	        ...
	        if (this.props.dragging) {
	            ...
	            this.props.onElementSetDrag(this.props.id, this.eventObj.liStartX + liTouchX, this.eventObj.liStartY + liTouchY);
	            e.preventDefault();
	        }
	    },
	...
	var TodoList = React.createClass({
	    ...
	    handleTouchEnd: function (e) {
	        ...
	        if (!this.state.dragging) {
	            if (this.eventObj.startY - this.eventObj.endY > -130 && this.eventObj.startY - this.eventObj.endY < -60 && Math.abs(this.eventObj.startX - this.eventObj.endX) < 25) {
	                this.handleAddEmptyObject();
	            }

	            if (this.eventObj.startY - this.eventObj.endY < -130 && Math.abs(this.eventObj.startX - this.eventObj.endX) < 25) {
	                this.handleUpdate();
	            }
	        }
	    },
	    ...
	    render: function () {
	        var todoNodes = this.state.todos.map(function (todo, i) {
	            return [this.state.draggingElement.overKey === -1 && i === 0 ? React.createElement('li', { key: 'empty-li', className: 'empty-li' }) : undefined, React.createElement(TodoListItemComponent, {
	                key: todo._id,
	                id: todo._id,
	                text: todo.text || '',
	                prev: todo.prev || null,
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'ul',
	                        { className: 'loading' },
	                        React.createElement('li', { className: this.state.loadingVisible ? '' : 'li-hidden' }),
	                        React.createElement('li', { className: this.state.loadingVisible ? '' : 'li-hidden' }),
	                        React.createElement('li', { className: this.state.loadingVisible ? '' : 'li-hidden' })
	                    )
	                )
