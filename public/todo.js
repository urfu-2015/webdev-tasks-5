...
/***/ function(module, exports, __webpack_require__) {
	...
	var update = function update() {
	    fetch('/api/v1/todo').then(function (response) {
	        ...
	        function render() {
	            _reactDom2.default.render(_react2.default.createElement(_todo2.default, null), rootEl);
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoItem = __webpack_require__(162);
	...
	var root = _react2.default.createElement('div');
	module.exports = _react2.default.createClass({
	    ...
	    updateTouchStart: function updateTouchStart(event) {
	        //event.preventDefault();
	        initialUpdatePoint = event.changedTouches[0];
	    },
	    updateTouchEnd: function updateTouchEnd(event) {
	        var self = this;
	        //event.stopPropagation();
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            {
	                onTouchStart: this.updateTouchStart, onTouchEnd: this.updateTouchEnd, className: (0, _classnames2.default)({
	                    'todo-list--update': this.state.update
	                })
	            },
	            _react2.default.createElement('img', { src: '/images/loading.gif', className: 'todo-list--preload' }),
	            ...
	            _react2.default.createElement(TodoForm, { onTodoSubmit: this.createTodo })
	        );
	    }
	});
	...
	var TodoForm = _react2.default.createClass({
	    ...
	    handleSubmit: function handleSubmit(e) {
	        e.preventDefault();
	        var taskInput = _reactDom2.default.findDOMNode(this.refs.todo);
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'form',
	            { onSubmit: this.handleSubmit, className: 'todo-input' },
	            _react2.default.createElement('input', { type: 'text', className: 'todo-form__input', ref: 'todo' }),
	            _react2.default.createElement('input', { type: 'submit', className: 'todo-form__button', value: 'Добавить todo' })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = _react2.default.createClass({
	    ...
	    viewTrash: function viewTrash(event) {
	        var element = event.currentTarget;
	        event.preventDefault();
	    ...
	    delTodoTap: function delTodoTap(event) {
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'section',
	            { id: this.props.id, className: (0, _classnames2.default)('todo-list__item', {
	            ...
	            _react2.default.createElement(
	                'div',
	                { className: 'todo-list__item_text' },
	                this.props.todo
	            ),
	            _react2.default.createElement('input', { ref: 'editField', className: 'todo-list__item_input',
	                defaultValue: this.props.todo,
	                onBlur: this.updateTodo }),
	            _react2.default.createElement('img', { src: '/images/trash.png', className: 'todo-list__item_trash',
