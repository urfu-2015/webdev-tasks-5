...
/***/ function(module, exports, __webpack_require__) {
	...
	var _page = __webpack_require__(169);
	...
	socket.on('init todos', function (data) {
	    store.dispatch((0, _actions.InitTodos)(data.todos));
	});
	
	var store = (0, _redux.createStore)(_reducers.TodoApp);
	
	function render() {
	    _reactDom2.default.render(_react2.default.createElement(_page2.default, { store: store }), document.getElementById('root'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reloader = __webpack_require__(171);
	
	var _reloader2 = _interopRequireDefault(_reloader);
	
	var _addButton = __webpack_require__(173);
	...
	var Page = function (_Component) {
	    ...
	    _createClass(Page, [{
	        key: 'touchStarter',
	        value: function touchStarter(event) {
	            event.stopPropagation();
	            this.startPoint = {};
	        ...
	        key: 'touchEnder',
	        value: function touchEnder(event) {
	            event.stopPropagation();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reloader = function (_Component) {
	    _inherits(Reloader, _Component);
	
	    function Reloader(props) {
	        _classCallCheck(this, Reloader);
	
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Reloader).call(this, props));
	
	        _this.makeUpdate = _this.makeUpdate.bind(_this);
	        return _this;
	    }
...
/***/ function(module, exports) {
	...
	var InitTodos = exports.InitTodos = function InitTodos(todos) {
	    return {
	        type: 'INIT_TODOS',
	        todos: todos
	    };
	...
	var SelectTodo = exports.SelectTodo = function SelectTodo(selectedTodo) {
	    return {
	        type: 'SELECT_TODO',
	...
	var ChangeTodo = exports.ChangeTodo = function ChangeTodo(todo, newTodoValue) {
	    return {
	        type: 'CHANGE_TODO',
	        todo: todo,
	...
	var ShowDeleteTodo = exports.ShowDeleteTodo = function ShowDeleteTodo(todo) {
	    return {
	...
	var HideDeleteTodo = exports.HideDeleteTodo = function HideDeleteTodo() {
	    return {
	        type: 'HIDE_DELETE_TODO'
	    };
	};
	
	var ShowReloadTodos = exports.ShowReloadTodos = function ShowReloadTodos() {
	    return {
	        type: 'SHOW_RELOAD_TODOS'
	    };
	};
	
	var ReloadTodos = exports.ReloadTodos = function ReloadTodos() {
	    return {
	...
	var addButton = function (_Component) {
	    ...
	    _createClass(addButton, [{
	        ...
	        value: function onClick(event) {
	            event.preventDefault();
	            this.props.store.dispatch((0, _actions.AddTodo)(document.getElementById('input-text').value));
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement('input', { id: 'input-text', type: 'text', style: this.textInputStyle }),
	                            _react2.default.createElement('input', { id: 'submit-btn', onClick: this.onClick, className: 'submit-btn', type: 'submit',
	                                value: 'Добавить' })
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoElement = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var todoElement = function (_Component) {
	    _inherits(todoElement, _Component);
	    ...
	    _createClass(todoElement, [{
	        ...
	        key: 'getClassByNumber',
	        value: function getClassByNumber(className, number) {
	        ...
	        value: function submitForm(event) {
	            this.props.store.dispatch((0, _actions.ChangeTodo)(this.props.id, document.getElementById("input-change-text-" + this.props.id).value));
	            event.preventDefault();
	            event.stopPropagation();
	        }
	    }, {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    isChange ? _react2.default.createElement(
	                        'form',
	                        { className: 'changeForm', action: '#1', method: 'POST', onSubmit: this.submitForm },
	                        _react2.default.createElement('input', { ref: 'myTextInput', autoFocus: true, id: "input-change-text-" + id, type: 'text', style: this.textInputStyle, defaultValue: "" + value }),
	                        _react2.default.createElement('input', { type: 'submit', className: 'submit-change-btn', defaultValue: 'Изменить' })
	                    ) : value
	                ),
