...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer = __webpack_require__(175);
	
	var _swipe = __webpack_require__(176);
	
	var _delItem = __webpack_require__(178);
	
	var _saveItem = __webpack_require__(179);
	
	var _replace = __webpack_require__(180);
	
	var _transforms = __webpack_require__(174);
	
	var _updater = __webpack_require__(177);
	
	var _clientRequest = __webpack_require__(172);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	__webpack_require__(181);
	
	var store = (0, _redux.createStore)(_reducer.noteApp);
	
	function render() {
	    _reactDom2.default.render(_react2.default.createElement(_main2.default, { store: store }), document.querySelector('.wrapper'));
	}
	
	var lastEvent;
	var direction = 'x';
	
	(0, _clientRequest.update)(store);
	...
	document.querySelector('.add').addEventListener('submit', function (event) {
	    ...
	    (0, _clientRequest.create)(store, note);
	}, false);
	...
	function replace() {
	    ...
	    direction = 'y';
	    (0, _replace.initShift)(startPoint.target.closest('.container__item'));
	}
	
	document.querySelector('.delete').addEventListener('touchstart', _delItem.handlerDelete, false);
	...
	document.addEventListener('touchstart', function (event) {
	    if (event.targetTouches.length === 1) {
	        ...
	        (0, _saveItem.resetSave)(touch, store);
	        ...
	        if (finalPoint) {
	            (0, _transforms.resetTransform)(finalPoint.target.closest('.container__item'));
	        }
	...
	document.addEventListener('touchmove', function (event) {
	    ...
	    if (event.targetTouches.length == 1 && countMove > 5) {
	        ...
	        if (absY > absX && direction === 'x' && touch.pageY < document.documentElement.clientHeight) {
	            (0, _updater.shiftUpdater)(absY);
	        }
	
	        if (!item) return;
	
	        if (absX < item.offsetWidth * 0.2 && direction === 'x') {
	            (0, _transforms.setTransformX)(item, touch.pageX - startPoint.pageX);
	        }
	
	        if (direction === 'y') {
	            event.preventDefault();
	            (0, _transforms.setTransformY)(item, touch.pageY - startPoint.pageY);
	            (0, _replace.shift)(touch);
	        }
	    }
	    countMove += 1;
	}, false);
	...
	document.addEventListener('touchend', function (event) {
	    clearTimeout(longTouch);
	    (0, _transforms.resetTransform)(startPoint.target.closest('.container__item'));
	    var target = event.changedTouches[0].target;
	    countMove = 0;
	
	    if (event.changedTouches.length == 1 && lastEvent === 'touchstart' && direction === 'x' && (target.className === 'container__item' || target.className === 'container__item_text')) {
	        (0, _saveItem.renderSave)(target, store);
	        event.preventDefault();
	        return;
	    }
	
	    if (event.changedTouches.length === 1 && lastEvent === 'touchmove' && direction === 'x') {
	        if (target.closest('.container__item') && startPoint.pageX - finalPoint.pageX > target.closest('.container__item').offsetWidth * 0.2) {
	            (0, _swipe.swipeLeft)(target.closest('.container__item'));
	            (0, _delItem.createDel)(target.closest('.container__item'));
	        } else {
	            (0, _transforms.resetTransform)(finalPoint.target.closest('.container__item'));
	            if (finalPoint.pageY - startPoint.pageY >= 50) {
	                (0, _swipe.swipeDown)(store, finalPoint);
	                (0, _updater.startRotate)();
	            } else {
	                (0, _updater.resetUpdater)();
	            }
	        }
	    ...
	    if (event.changedTouches.length == 1 && lastEvent === 'touchmove' && direction === 'y') {
	        (0, _replace.finishShift)(store);
	
	        (0, _clientRequest.updateOrder)(store);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	    ...
	    var selectedNote = _store$getState.selectedNote;
	
	
	    var eventDecor = function eventDecor(event) {
	        event.preventDefault();
	
	        (0, _clientRequest.save)(selectedNote, store);
	    };
	
	    if (selectedNote && name === selectedNote) {
	        return _react2.default.createElement(
	            'form',
	            { method: 'POST', action: '/change-note', className: 'save', onSubmit: eventDecor },
	            _react2.default.createElement('input', { defaultValue: name, type: 'text', className: 'save__text' }),
	            _react2.default.createElement('input', { type: 'submit', value: 'Save', className: 'save__btn' })
	        );
	    }
	
	    return _react2.default.createElement(
	        'p',
	        { className: 'container__item_text' },
	        name
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.deleteItem = exports.save = exports.create = exports.updateOrder = exports.update = undefined;
	...
	var update = exports.update = function update(store, successHandler) {
	    xhrRequest('GET', '/list-notes', function (response) {
	        var names = response.map(function (note) {
	            return note.name;
	        });
	
	        var action = (0, _actions.getNotes)(names);
	...
	var updateOrder = exports.updateOrder = function updateOrder(store) {
	    var body = '';
	    var divsNotes = [].concat(_toConsumableArray(document.querySelectorAll('.container__item')));
	    divsNotes.forEach(function (name) {
	        (0, _transforms.resetTransform)(name);
	    ...
	    xhrRequest('PUT', '/change-chain', function (response) {
	        var action = (0, _actions.getNotes)(response);
	        store.dispatch(action);
	    }, body);
	};
	
	var create = exports.create = function create(store, note) {
	    var body = 'name=' + encodeURIComponent(note);
	
	    xhrRequest('POST', '/add-note', function (response) {
	        var action = (0, _actions.addNote)(response.name);
	        store.dispatch(action);
	...
	var save = exports.save = function save(textSaveItem, store) {
	    ...
	    xhrRequest('PUT', '/change-note', function (response) {
	        var action = (0, _actions.changeNote)(textSaveItem, response.name);
	        store.dispatch(action);
	    }, body);
	};
	
	var deleteItem = exports.deleteItem = function deleteItem(target, successHandler) {
	    var name = target.childNodes[0].innerText;
	    var body = 'name=' + encodeURIComponent(name);
	
	    xhrRequest('DELETE', 'delete-note', function (response) {
	        var action = (0, _actions.deleteNote)(response.name);
	        store.dispatch(action);
...
/***/ function(module, exports) {
	...
	var getNotes = exports.getNotes = function getNotes(notes) {
	    return {
	        type: 'GET_NOTES',
	        notes: notes
	    };
	...
	var callSaveForm = exports.callSaveForm = function callSaveForm(note) {
	    return {
	        type: 'CALL_SAVE_FORM',
	        note: note
	    };
	...
	var resetSaveForm = exports.resetSaveForm = function resetSaveForm(note) {
	    return {
	...
	var changeNote = exports.changeNote = function changeNote(note, newText) {
	    return {
	        type: 'CHANGE_NOTE',
	        note: note,
	        newText: newText
	...
	var changeOrder = exports.changeOrder = function changeOrder(changeChain) {
	    return {
	        type: 'CHANGE_ORDER',
...
/***/ function(module, exports) {
	...
	var resetTransform = exports.resetTransform = function resetTransform(target) {
	    if (!target) return;
	
	    target.style.transform = 'translateX(' + 0 + ') translateY(' + 0 + ')';
	};
	
	var setTransformX = exports.setTransformX = function setTransformX(target, value) {
	    if (!target) return;
	
	    target.style.transform = "translateX(" + value + "px)";
	};
	
	var setTransformY = exports.setTransformY = function setTransformY(target, value) {
	    if (!target) return;
...
/***/ function(module, exports) {
	...
	exports.noteApp = function (state, action) {
	    ...
	    switch (action.type) {
	        ...
	        case 'DELETE_NOTE':
	            ...
	            newNotes.splice(state.notes.indexOf(undefined), 1);
	        ...
	        case 'CHANGE_ORDER':
	            ...
	            var nextOrder;
	            action.changeChain.slice(1).forEach(function (name) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.swipeDown = exports.swipeLeft = undefined;
	...
	var swipeLeft = exports.swipeLeft = function swipeLeft(target) {
	    if (!target) return;
	    target.style.transform = 'translateX(-' + 20 + '%)';
	};
	
	var swipeDown = exports.swipeDown = function swipeDown(store, finalPoint) {
	    if (finalPoint.pageY < document.documentElement.clientHeight) {
	        event.preventDefault();
	        document.body.style.marginTop = 0;
	        (0, _clientRequest.update)(store, function () {
	            (0, _updater.resetUpdater)();
	            (0, _updater.stopRotate)();
	        });
	    }
	};
...
/***/ function(module, exports) {
	...
	var shiftUpdater = exports.shiftUpdater = function shiftUpdater(value) {
	    if (value > 50) return;
	    document.body.style.marginTop = -50 + value + 'px';
	};
	
	var resetUpdater = exports.resetUpdater = function resetUpdater() {
	    document.body.style.marginTop = -50 + 'px';
	};
	
	var startRotate = exports.startRotate = function startRotate() {
	    document.querySelector('.reload__img').style.animationPlayState = 'running';
	};
	
	var stopRotate = exports.stopRotate = function stopRotate() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.createDel = exports.handlerDelete = exports.resetDel = undefined;
	
	var _clientRequest = __webpack_require__(172);
	
	var target = null;
	
	var resetDel = exports.resetDel = function resetDel() {
	...
	var handlerDelete = exports.handlerDelete = function handlerDelete(event) {
	    (0, _clientRequest.deleteItem)(target, resetDel);
	};
	
	var createDel = exports.createDel = function createDel(targetItem) {
	    var del = document.querySelector('.delete');
	    target = targetItem;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.resetSave = exports.renderSave = undefined;
	
	var _actions = __webpack_require__(173);
	
	var renderSave = exports.renderSave = function renderSave(target, store) {
	    var textSaveItem;
	    ...
	    var action = (0, _actions.callSaveForm)(textSaveItem);
	    store.dispatch(action);
	    document.querySelector('.save__text').focus();
	};
	
	var resetSave = exports.resetSave = function resetSave(touch, store) {
	    if (document.querySelector('.save') && !touch.target.closest('.save')) {
	        var action = (0, _actions.getNotes)(store.getState().notes);
	        store.dispatch(action);
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.finishShift = exports.shift = exports.initShift = undefined;
	...
	var initShift = exports.initShift = function initShift(target) {
	    if (target) {
	        var divsNotes = [].concat(_toConsumableArray(document.querySelector('.container').childNodes));
	...
	var shift = exports.shift = function shift(touch) {
	...
	function condition(touch, step) {
	    ...
	    if (stack.indexOf(divsNotes[currentOrder + step]) > -1) {
	        return touch.pageY < stack[stack.length - 2].offsetTop + stack[stack.length - 2].offsetHeight / 2 && touch.pageY > stack[stack.length - 2].offsetTop;
	    }
	    return touch.pageY < divsNotes[currentOrder + step].offsetTop + divsNotes[currentOrder + step].offsetHeight / 2 && touch.pageY > divsNotes[currentOrder + step].offsetTop;
	}
	...
	var finishShift = exports.finishShift = function finishShift(store) {
	    if (stack.length === 1) {
	        return;
	    }
	
	    var stringStack = stack.map(function (item) {
	        return item.childNodes[0].innerHTML;
	    });
	
	    var action = (0, _actions.changeOrder)(stringStack);
	    store.dispatch(action);
