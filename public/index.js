...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer = __webpack_require__(173);
	...
	function replace() {
	    if (target.closest('.container__item') && !saveItem) {
	        ...
	        direction = 'y';
	        divsNotes = [].concat(_toConsumableArray(container.childNodes));
	...
	function swipe(xAbs, yAbs, event) {
	    if (xAbs > yAbs) {
	        //Свайп влево
	        if (finalPoint.pageX < initialPoint.pageX && finalPoint.target.closest('.container__item') && direction === 'x') {
	...
	function render() {
	    _reactDom2.default.render(_react2.default.createElement(_main2.default, { store: store }), wrapper);
	}
	...
	document.addEventListener('touchstart', function (event) {
	    if (event.targetTouches.length === 1) {
	        ...
	        if (!touch.target.closest('.save') && saveItem) {
	            var action = (0, _actions.callSaveForm)(textSaveItem, false);
	            store.dispatch(action);
	            saveItem = undefined;
	        }
	...
	document.addEventListener('touchend', function (event) {
	    if (event.changedTouches.length == 1 && lastEvent === 'touchstart') {
	        ...
	        if (target.className !== 'container__item' && target.className !== 'container__item__text') {
	            return;
	        }
	        ...
	        if (direction === 'x') {
	            var action = (0, _actions.callSaveForm)(textSaveItem, true);
	            store.dispatch(action);
	        }
	    ...
	    if (direction == 'y') {
	        ...
	        xhrRequest('PUT', '/change-chain', function (response) {
	            if (compare(store.getState().notes, response)) {
	                action = (0, _actions.getNotes)(response);
	                store.dispatch(action);
	            }
	        }, body);
	        return;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	    ...
	    var notes = _store$getState.notes;
	    var saveForm = _store$getState.saveForm;
	    ...
	    if (saveForm && name === selectedNote) {
	        return _react2.default.createElement(
	            "form",
	            { method: "POST", action: "/change-note", className: "save" },
	        ...
	        return _react2.default.createElement(
	            "p",
	            { className: "container__item__text" },
	            name
	        );
	    }
	};
...
/***/ function(module, exports) {
	...
	var callSaveForm = exports.callSaveForm = function callSaveForm(note, saveForm) {
	    return {
	        type: 'CALL_SAVE_FORM',
	        note: note,
	        saveForm: saveForm
