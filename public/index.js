...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todosPage = __webpack_require__(170);
	...
	var _httpRequest = __webpack_require__(174);
	...
	var store = (0, _redux.createStore)(_reducers.todosApp);
	
	function render() {
	    _reactDom2.default.render(_react2.default.createElement(_todosPage2.default, { store: store }), document.querySelector('#root'));
	}
	render();
	...
	function loadTodos() {
	    (0, _httpRequest.request)('GET', 'api/todos', null, function (data) {
	        data.todos.forEach(function (todo) {
	            store.dispatch((0, _actions.addTodo)(Object.assign({}, todo, {
	                isChanging: false,
	                isDeleting: false
	            })));
	        });
	...
	document.addEventListener('scroll-load', function (event) {
	    store.dispatch((0, _actions.clearTodos)());
	    loadTodos();
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todosContainer = __webpack_require__(171);
	...
	var TodosPage = function (_React$Component) {
	    ...
	    function TodosPage(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TodosPage).call(this, props));
	    }
	    ...
	    _createClass(TodosPage, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'root' },
	                _react2.default.createElement('div', { className: 'root__load' }),
	                _react2.default.createElement(
	                    'h1',
	                    { className: 'root__header' },
	                    'TODO-хи'
	                ),
	                _react2.default.createElement(_todosContainer2.default, { todos: todos, store: this.props.store }),
	                _react2.default.createElement(
	                    'button',
	                    { className: 'root__add-button' },
	                    'Добавить'
	                )
	            );
	        }
	        ...
	        value: function componentDidMount() {
	            ...
	            var addButton = document.querySelector('.root__add-button');
	
	            addButton.addEventListener('tap', function (event) {
	                (0, _httpRequest.request)('POST', 'api/todos', { text: 'Новое дело' }, function (todo) {
	                    _this2.props.store.dispatch((0, _actions.addTodo)(Object.assign({}, todo, {
	                        isChanging: true,
	                        isDeleting: false
	                    })));
	                });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodosContainer = function (_React$Component) {
	    _inherits(TodosContainer, _React$Component);
	
	    function TodosContainer(props) {
	        _classCallCheck(this, TodosContainer);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TodosContainer).call(this, props));
	    }
	    ...
	    _createClass(TodosContainer, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'root__todos-container todos-container' },
	...
	var Todo = function (_React$Component) {
	    ...
	    _createClass(Todo, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'todos-container__todo todo todo_id_' + todo._id + (todo.isDeleting ? ' todo_swiped' : '') + (todo.isChanging ? ' todo_modification' : '') },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'todo__text' + (todo.isChanging ? ' todo__text_hidden' : '') },
	                    todo.text
	                ),
	                _react2.default.createElement(
	                    'div',
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'todo__form input-form' + (todo.isChanging ? '' : ' todo__form_hidden') },
	                    _react2.default.createElement('textarea', { className: 'input-form__input', defaultValue: todo.text }),
	                    _react2.default.createElement(
	                        'button',
	        ...
	        value: function componentDidMount() {
	            ...
	            var todo = this.props.todo;
	            var todoElement = document.querySelector('.todo_id_' + todo._id);
	
	            todoElement.addEventListener('tap', function (event) {
	                var todo = _this2.props.todo;
	
	                if (!todo.isChanging && !todo.isDeleting) {
	                    _this2.props.store.dispatch((0, _actions.changeTodo)(Object.assign({}, todo, {
	                        isChanging: true
	                    })));
	                }
	            });
	            ...
	            var deleteButton = document.querySelector('.todo_id_' + todo._id + ' .todo__delete');
	            ...
	            deleteButton.addEventListener('tap', function (event) {
	                ...
	                if (todo.isDeleting) {
	                    ...
	                    (0, _httpRequest.request)('DELETE', 'api/todos/' + todo._id, {}, function () {
	                        _this2.props.store.dispatch((0, _actions.deleteTodo)(todo._id));
	                    });
	                }
	            });
	
	            var submitButton = document.querySelector('.todo_id_' + todo._id + ' .input-form__submit');
	            ...
	            submitButton.addEventListener('tap', function (event) {
	                ...
	                if (todo.isChanging) {
	                    (function () {
	                        var newText = document.querySelector('.todo_id_' + todo._id + ' .input-form__input').value;
	
	                        event.preventDefault();
	                        event.stopPropagation();
	
	                        (0, _httpRequest.request)('PATCH', 'api/todos/' + todo._id, { text: newText }, function () {
	                            _this2.props.store.dispatch((0, _actions.changeTodo)(Object.assign({}, todo, {
	                                text: newText,
	                                isChanging: false
	                            })));
...
/***/ function(module, exports) {
	...
	var clearTodos = exports.clearTodos = function clearTodos() {
	    return {
	        type: 'CLEAR_TODOS'
	    };
	};
...
/***/ function(module, exports) {
	...
	var request = exports.request = function request(method, location, body, callback) {
...
/***/ function(module, exports) {
	...
	exports.todosApp = function (state, action) {
...
/***/ function(module, exports) {
	...
	function handleTouchEnd(event) {
	    ...
	    if (Math.abs(touch.startPosition.pageX - event.changedTouches[0].pageX) < 5 && Math.abs(touch.startPosition.pageY - event.changedTouches[0].pageY) < 5) {
	        event.target.dispatchEvent(new Event('tap', { bubbles: true }));
	        return;
	    }
	
	    if (Math.abs(touch.startPosition.pageY - event.changedTouches[0].pageY) < 20 && touch.startPosition.pageX - event.changedTouches[0].pageX > 50) {
	        event.target.dispatchEvent(new Event('swipe-left', { bubbles: true }));
	        return;
	    }
	
	    if (Math.abs(touch.startPosition.pageY - event.changedTouches[0].pageY) < 20 && event.changedTouches[0].pageX - touch.startPosition.pageX > 50) {
	...
	function handleTouchMove(event) {
	    if (window.pageYOffset + 60 >= event.changedTouches[0].pageY - touch.startPosition.pageY) {
	        document.querySelector('.root__load').style.top = -30 + event.targetTouches[0].pageY - touch.startPosition.pageY - window.pageYOffset + 'px';
	    }
	}
