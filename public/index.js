...
/***/ function(module, exports, __webpack_require__) {
	...
	var _swipe = __webpack_require__(183);
	
	var _delItem = __webpack_require__(185);
	
	var _saveItem = __webpack_require__(186);
	
	var _replace = __webpack_require__(187);
	
	var _transforms = __webpack_require__(181);
	
	var _updater = __webpack_require__(184);
	
	var _clientRequest = __webpack_require__(179);
	...
	document.querySelector('.delete').addEventListener('orientationchange', _delItem.moveDel, false);
	...
	document.addEventListener('touchend', function (event) {
	    ...
	    if (event.changedTouches.length === 1 && lastEvent === 'touchmove' && direction === 'x') {
	        if (target.closest('.container__item') && startPoint.pageX - finalPoint.pageX > target.closest('.container__item').offsetWidth * 0.2) {
	            ...
	            (0, _delItem.createDel)(target.closest('.container__item'), store);
	        } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deleteItem = exports.deleteItem = function deleteItem(target, store, successHandler) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.moveDel = exports.createDel = exports.handlerDelete = exports.resetDel = undefined;
	...
	var handlerDelete = exports.handlerDelete = function handlerDelete(event) {
	    event.stopPropagation();
	    (0, _clientRequest.deleteItem)(target, store, function () {
	        resetDel();
	    });
	};
	
	var createDel = exports.createDel = function createDel(targetItem, currStore) {
	    var del = document.querySelector('.delete');
	...
	var moveDel = exports.moveDel = function moveDel() {
